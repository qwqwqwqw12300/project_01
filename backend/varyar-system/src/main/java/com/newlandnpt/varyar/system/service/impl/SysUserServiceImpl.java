...
import com.newlandnpt.varyar.common.utils.bean.BeanValidators;
import com.newlandnpt.varyar.common.utils.spring.SpringUtils;
import com.newlandnpt.varyar.system.domain.SysPost;
import com.newlandnpt.varyar.system.domain.SysUserPost;
import com.newlandnpt.varyar.system.domain.SysUserRole;
import com.newlandnpt.varyar.system.mapper.SysPostMapper;
import com.newlandnpt.varyar.system.mapper.SysRoleMapper;
import com.newlandnpt.varyar.system.mapper.SysUserMapper;
import com.newlandnpt.varyar.system.mapper.SysUserPostMapper;
...
public class SysUserServiceImpl implements ISysUserService
{
    ...
    {
        Long userId = StringUtils.isNull(user.getUserId()) ? -1L : user.getUserId();
        SysUser info = userMapper.checkPhoneUnique(user.getMobilePhone());
        if (StringUtils.isNotNull(info) && info.getUserId().longValue() != userId.longValue())
        {
            return UserConstants.NOT_UNIQUE;
        }
