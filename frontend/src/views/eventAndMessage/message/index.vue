<template>
    <div class="app-container">
      ...
      <el-table v-loading="loading" :data="msgList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="处理人会员id" align="center" prop="memberId" />
        <el-table-column label="已读未读标志" align="center" prop="operateFlag" />
  ...
  <script>
  import { listMsg, getMsg, delMsg, addMsg, updateMsg } from "@/api/eventAndMessage/message";
