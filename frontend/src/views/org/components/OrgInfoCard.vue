<template>
    <el-card class="box-card">
      ...
      <el-descriptions :column="2">
        ...
        <el-descriptions-item label="第一服务电话">{{ org== undefined?"":org.phone1 }}({{ org== undefined?"":org.attendantName1 }})</el-descriptions-item>
        <el-descriptions-item label="第二服务电话">{{ org== undefined?"":org.phone2 }}({{ org== undefined?"":org.attendantName2 }})</el-descriptions-item>
        <el-descriptions-item label="第三服务电话">{{ org== undefined?"":org.phone3 }}({{ org== undefined?"":org.attendantName3 }})</el-descriptions-item>
      </el-descriptions>
    </el-card>
</template>
