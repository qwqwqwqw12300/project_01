<template>
    <el-card class="box-card">
      ...
      <el-descriptions :column="2" v-if="org">
        ...
        <el-descriptions-item label="第一服务电话">{{ org.phone1 }}<span v-if="org.attendantName1">({{ org.attendantName1 }})</span></el-descriptions-item>
        <el-descriptions-item label="第二服务电话">{{ org.phone2 }}<span v-if="org.attendantName3">({{ org.attendantName3 }})</span></el-descriptions-item>
        <el-descriptions-item label="第三服务电话">{{ org.phone3 }}<span v-if="org.attendantName3">({{ org.attendantName3 }})</span></el-descriptions-item>
      </el-descriptions>
    </el-card>
</template>
