<template>
    ...
    <el-card class="box-card">
      ...
      <el-descriptions :column="3">
        ...
        <el-descriptions-item label="紧急联系电话1：">{{ member== undefined?"":member.phone }}</el-descriptions-item>
        <el-descriptions-item label="紧急联系电话2：">{{ member== undefined?"":member.phone }}</el-descriptions-item>
        <el-descriptions-item label="紧急联系电话3：">{{ member== undefined?"":member.phone }}</el-descriptions-item>
      </el-descriptions>
    </el-card>
</template>
