...
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `remark`) VALUES (2002, '首页（运营人员）', 0, 1, 'operateAdminHome', 'home/operateAdmin/index', NULL, 1, 0, 'C', '0', '0', 'home:biz:list', 'dashboard', 'superAdmin', NULL, '');
...
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `remark`) VALUES (2057, '查询', 2005, 1, '', NULL, NULL, 1, 0, 'F', '0', '0', 'member:query', '#', 'superAdmin', NULL, '');
