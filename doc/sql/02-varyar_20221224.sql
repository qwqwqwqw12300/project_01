...
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `remark`) VALUES (2005, '会员管理', 0, 5, 'member', NULL, NULL, 1, 0, 'M', '0', '0', NULL, 'peoples', 'superAdmin', NULL, '');
...
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `remark`) VALUES (2065, '会员设备查询', 2005, 1, 'member', 'member/index', NULL, 1, 0, 'C', '0', '0', 'member:list', 'peoples', 'superAdmin', NULL, '');
