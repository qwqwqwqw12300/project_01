...
INSERT INTO `t_org` (`org_id`, `parent_id`, `ancestors`, `org_name`, `org_no`, `order_num`, `leader`, `leaderphone`, `type`, `address`, `attendant_name1`, `attendant_name2`, `attendant_name3`, `phone1`, `phone2`, `phone3`, `status`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`) VALUES (100, 0, '0', '顶级机构', '100', 0, NULL, NULL, '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', '0', 'admin', '2022-12-19 02:23:41', '', NULL);
...
create table t_event (
  ...
  level              varchar(50)     default ''               comment '级别（0:重要事件  1：普通事件）',
