    ...
    <app-body :hideTitle="true">
      ...
      <view class="ui-tab" v-if="tabList.length">
        <u-tabs @change="tabChange" :list="tabList" lineColor="unset"
          :activeStyle="{color: '#353535', fontSize: '45rpx'}" :inactiveStyle="{color: '#888888', fontSize: '40rpx'}">
        </u-tabs>
      </view>
      <!-- /家庭tab -->
          ...
          <view class="ui-group" v-for="(familyItem, index) of familyList" :key="'family' + index">
            <view class="ui-title">
              ...
              <view class="ui-share-box">
                <u-text @click="editClick(familyItem)" prefixIcon="../../static/images/index/edit.png" size="32rpx"
                  :align="'right'" :block="false" :iconStyle="{
									height: '40rpx', width: '40rpx'
								}" text="编辑" v-if="familyItem.shareFlag === '2'"></u-text>
                <u-text @click="goPage('/pages/share/share?familyId='+ familyItem.familyId + '&name='+ familyItem.name)"
                  prefixIcon="../../static/images/index/share.png" size="32rpx" :align="'right'" :block="false"
                  :iconStyle="{
									height: '40rpx', width: '40rpx'
            ...
            <view class="ui-device">
              <!-- 房间 -->
              <room-card :rooms="familyItem.rooms" :shareFlag="familyItem.shareFlag" @confirm="handleInitList" />
              <!-- 房间 -->
              <!-- 人员 -->
              <human-card :humans="familyItem.humans" :shareFlag="familyItem.shareFlag" @confirm="handleInitList" />
              <!-- 人员 -->
              <!-- 新增房间 -->
