        ...
        <view class="ui-body">
          <view class="ui-w-h-100">
            ...
            <movable-area class="ui-f-between ui-mar-t-10  ui-f-wrap ui-w-h-100" ref="areaBox" id="areaBox"
              ...
              <view class="ui-w-48 ui-white-bg ui-br-16 ui-f-wrap ui-mar-t-20 " v-for="(item,index) in listData_c"
                :key="index" :id="'appLi' + index" :class="(hoverClass==='appLi'+index)?'select':''"
                @touchstart="AppLi_touchstart(index,$event)" @touchmove="AppLi_touchmove"
                @touchend="AppLi_touchend(index)" v-if="item.isShow || isEdit">
                <SleepCard v-if="item.type === '1'" :date="date" :sleepMap="sleepMap" :item="item" :isEdit="isEdit"
                  @iconClick="editCard"></SleepCard>
                <view class="" v-if="deviceList.length">
                  <XinLvCard v-if="item.type === '2' "
                    ...
                    :fetchRes="fetchRes" :option="xinLvOption" :item="item" :isEdit="isEdit" @iconClick="editCard">
                  </XinLvCard>
                  <XueYaCard v-if="item.type === '3'"
                    ...
                    :fetchRes="fetchRes" :option="xueYaOption" :item="item" :isEdit="isEdit" @iconClick="editCard">
                  </XueYaCard>
                  <XueYangCard v-if="item.type === '4'"
                    ...
                    :fetchRes="fetchRes" :option="xueYangOption" :item="item" :isEdit="isEdit" @iconClick="editCard">
                  </XueYangCard>
                  <XinDianCard v-if="item.type === '5'"
                    ...
                    :fetchRes="fetchRes" :option="xinDianOption" :item="item" :isEdit="isEdit" @iconClick="editCard">
                  </XinDianCard>
                  <TiWenCard v-if="item.type === '6'"
                    ...
                    :fetchRes="fetchRes" :option="tiWenOption" :item="item" :isEdit="isEdit" @iconClick="editCard">
                  </TiWenCard>
                </view>
              </view>
              <!-- 滑块 -->
              <movable-view v-if="moviewShow" :animation="false" class="ui-mov-view ui-br-16" :x="moveX" :y="moveY"
                direction="all" :style="{ width: moveViewSize + 'rpx', height: 270 + 'rpx' }">
  ...
  export default {
    ...
    methods: {
      ...
      xinDianOptionHandle(res) {
        const dateRes = res.data && res.data.ElectrocardiogramTime.slice(0, 4) + '-' + res.data.ElectrocardiogramTime
          .slice(5,
            7) + '-' +
