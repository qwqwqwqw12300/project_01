<template>
  <app-body :bg="false" :bodyStyle="{backgroundColor:'#FFF'}" title="自动定位">
        ...
        <u-cell-group>
          <u-cell title="自动定位" titleStyle="font-size: 15px;color: #303133;">
            <view slot="value" class="u-slot-value">
              <u-switch space="2" v-model="switchValue" activeValue="1" inactiveValue="0" @change="handleSwitch"
                :loading="loading" size="20" activeColor="#FEAE43" inactiveColor="rgb(230, 230, 230)"></u-switch>
            </view>
          </u-cell>
