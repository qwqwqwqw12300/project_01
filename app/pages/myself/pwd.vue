...
<template>
  <app-body title="修改密码">
    ...
    <view class="ui-form">
      ...
      <view class="ui-form-item">
        <u-input placeholder="请输入新密码" v-model="form.newPassword" :password="eyes.new" :border="'none'" prefixIcon="lock"
          :prefixIconStyle="{fontSize: '48rpx', color: '#555'}" fontSize="40rpx" clearable>
          <template slot="suffix">
            <u-icon :name="eyes.new ? 'eye-off' : 'eye-fill'" @click="eyesChange('new')" color="rgb(144, 147, 153)"
              size="48rpx"></u-icon>
          </template>
        </u-input>
      </view>
      <view class="ui-form-item">
        <u-input placeholder="再次输入新密码" v-model="form.reNewPassword" :password="eyes.reNew" :border="'none'"
          ...
          <template slot="suffix">
            <u-icon :name="eyes.reNew ? 'eye-off' : 'eye-fill'" @click="eyesChange('reNew')" color="rgb(144, 147, 153)"
              size="48rpx"></u-icon>
          </template>
        </u-input>
      </view>
