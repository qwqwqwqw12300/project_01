<!--
* @Author: zhanch
* @Date: 2023-03-28 16:36:35
* @FilePath: /pages/myself/device-manage/components/watch-card.vue
* @Description: 4g手表设备
-->
	...
	<view class="wd-menu-item">
		<view class="item-box" @click="edit(device)">
			...
			<view class="device-info">
				<image src="/static/images/watch.png"></image>
				<view class="detail">
