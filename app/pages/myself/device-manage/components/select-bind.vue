...
<template>
	<view>
		<!-- 绑定房间 -->
		<u-popup :closeOnClickOverlay="false" :closeable="true" :round="10" :show="bindRoomShow" mode="center"
			@close="close">
			<view class="wd-add">
				...
				<view class="wd-add-box wd-add-box-room">
					...
					<view class="wd-select" @click="sheetRoomShow">
						...
						<u-input placeholder="请选择房间" border="surround" v-model="roomName" readonly
		...
		<u-action-sheet :actions="rangRoomList" :closeOnClickOverlay="true" :safeAreaInsetBottom="true"
