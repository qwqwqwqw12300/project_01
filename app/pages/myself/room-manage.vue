...
<template>
	<view id="roomMagege">
		<app-body>
			<u-navbar leftText="家庭" @rightClick="rightClick" :autoBack="true" bgColor="transparent" leftIconColor="#fff" :fixed="false" />
			<view class="ui-logo">我的房间管理</view>
			<view class="ui-menu">
				<u-grid>
					<u-grid-item v-for="(baseListItem, baseListIndex) in baseList" :key="baseListIndex">
						<view class="ui-menu-item" :border="false" @click="gridClick(baseListItem.id)">
							<u-icon :customStyle="{ paddingTop: 20 + 'rpx' }" name="/static/images/myself/room.png" size="60rpx"></u-icon>
