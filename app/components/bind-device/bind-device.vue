...
<template>
	<u-popup :closeable="true" :round="10" :show="show" mode="center" @close="close" @open="open">
		<view class="ui-add">
			<u-text prefixIcon="plus-circle" :iconStyle="{ fontSize: '38rpx', color: '#ea942f' }" color="#ea942f" size="30rpx" text="XX房间绑定设备"></u-text>
			<view class="ui-add-box">
				<u-text size="28rpx" prefixIcon="../../static/images/set-form.png" iconStyle="font-size: 25rpx" text="选择设备"></u-text>
			...
			<view class="ui-btn-group">
				<button @click="next" type="default">确定</button>
				<button @click="next" type="default">取消</button>
				<button @click="next" type="default">创建房间</button>
...
export default {
	...
	data() {
		return {
			show: true,
			value: 0,
			range: [{ value: 0, text: '设备一' }, { value: 1, text: '设备二' }, { value: 2, text: '设备三' }]
		};
	},
